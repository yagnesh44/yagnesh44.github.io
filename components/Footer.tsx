        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              aria-label="GitHub"
            >
              <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center mb-1.5 group-hover:bg-pink-900/50 transition-colors border border-gray-700 group-hover:border-pink-500/50">
            ...
            >
              ...
              <span className="text-xs font-medium text-gray-400 group-hover:text-pink-400 transition-colors">LinkedIn</span>
            </a>
            <a
              href="mailto:yagneshmangroliya1234@gmail.com"
              className="group flex flex-col items-center transition-all duration-300"
              aria-label="Email"
            >
              <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center mb-1.5 group-hover:bg-pink-900/50 transition-colors border border-gray-700 group-hover:border-pink-500/50">
              ...
              <span className="text-xs font-medium text-gray-400 group-hover:text-pink-400 transition-colors">Email</span>
            </a>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-sm text-gray-400 text-center">
              &copy; {new Date().getFullYear()} All rights reserved by Yagnesh Mangroliya
            </div>
          </div>
        </div>
      </div>
