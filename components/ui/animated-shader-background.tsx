...
const AnimatedShaderBackground = () => {
  ...
  useEffect(() => {
    ...
    // Crucial for performance: reduce pixel ratio
    ...
    const material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          // Reduced loop iterations from 35.0 to 15.0 for performance
    ...
    const animate = (time: number) => {
      ...
      // Throttle to ~30fps if needed, or just let it run if we're paused anyway
      if (!isVisible) return; 
